...
describe('New Validator constructor', function() {
  var validator;
  ...
  beforeEach(function () {
    validator = new Validator({
      ...
      password: {min:'The password invalid',text:'password'}
    });
  });

  it('should return messages about new errors function', function() {
    // if(validator.fails()){
    //   console.log(validator.errors.first())
    //   console.log(validator.errors.all(true))
    // }
    validator.fails();
  });
});
